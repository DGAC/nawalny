...
'''getNmLastInfo.py: use GeneralInformationServices to obtain last version of resources
available at NM level: wsdl, xsd, versions, documentations, '''
...
if __name__ == '__main__':
    ...
    for (squery, daddpar, opostp) in lqueryset:   # lqueryset[2:3] :
        ...
        try: 
            ...
            print("[%s]" % squery)
            ologger.info(pprint.pformat(dresult))
            if opostp :
